...
<c:import url="/WEB-INF/views/layout/app.jsp">
    <c:param name="content">
        ...
        <table id="report_list">
            <tbody>
                <tr>
                    ...
                    <th class="report_date">Date of report</th>
                ...
                <c:forEach var="report" items="${reports}" varStatus="status">
                    ...
                    <tr class="row${status.count % 2}">
                        ...
                        <td class="report_action"><a href="<c:url value='?action=${actRep}&command=${commShow}&id=${report.id }' />">Show detail</a>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
        ...
        <p><a href="<c:url value='?action=${actRep}&command=${commNew}' />">Register a new daily report</a></p>
    </c:param>
</c:import>
